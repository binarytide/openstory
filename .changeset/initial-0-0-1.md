...
- `openbook/plugin`: Vite plugin that discovers `*.stories.{ts,tsx,js,jsx}`, serves `/__openbook/manifest.json` and `/__story/:id`, synthesizes per-story virtual entry modules.
