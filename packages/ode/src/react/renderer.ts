import { OdeAdapterMissingFrameworkError } from "../errors.js";
import type { OdeRenderer } from "../types.js";
...
const ensureReactDom = async (): Promise<ReactDomClient> => {
  ...
  try {
    ...
    throw new OdeAdapterMissingFrameworkError("react", "react react-dom");
  }
};

export const renderer: OdeRenderer<unknown, ReactMounted> = {
