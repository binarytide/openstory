...
import type { Meta, StoryObj } from "ode/solid";
// @ts-expect-error — ode/test has no DTS by design.
...
export const Primary: Story = {
  ...
  play: async ({ canvasElement }) => {
    await waitFor(() => {
      const button = canvasElement.querySelector("[data-ode-test='simple-button']");
