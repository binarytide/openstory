...
import type { OpenbookRenderer } from "../types.js";
...
const ensureReactDom = async (): Promise<ReactDomClient> => {
  ...
  try {
    ...
    throw new OpenbookAdapterMissingFrameworkError("react", "react react-dom");
  }
};

export const renderer: OpenbookRenderer<unknown, ReactMounted> = {
