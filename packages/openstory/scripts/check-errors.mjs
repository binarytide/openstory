#!/usr/bin/env node
// Quality bar: every throw in packages/openstory/src/ (excluding errors.ts) must use a typed OpenstoryError class.
...
if (violations.length > 0) {
  console.error("Found throws that don't use a typed OpenstoryError class:\n");
...
console.log("All throws in src/ use typed OpenstoryError classes.");
