...
export const runPreview = async (projectRoot: string, options: PreviewOptions): Promise<void> => {
  ...
  process.stdout.write(
    `openstory preview: serving ${absoluteOutDir} on http://127.0.0.1:${options.port}\n`,
  );
};
